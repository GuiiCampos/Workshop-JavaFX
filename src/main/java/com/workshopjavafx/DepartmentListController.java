...
import com.workshopjavafx.db.DbIntegrityException;
...
public class DepartmentListController implements Initializable, DataChangeListener {
    ...
    private void createDialogForm(Department dp, String absoluteName, Stage parentStage) {
        try {
            ...
            controller.setEnitty(dp);
            controller.setDpService(new DepartmentService());
    ...
    private void removeEntity(Department obj) {
        ...
        if (result.get() == ButtonType.OK) {
            ...
            try {
                ...
                Alerts.showAlert("Eroor removing object", null, e.getMessage(), Alert.AlertType.ERROR);
            }
        }
    }
}
